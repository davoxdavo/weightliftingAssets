...
Form guides that are still hand-drawn diagrams and should be regenerated as AI art — names, current image and the prompt for each: [`FORM_GUIDE_IMAGE_TODO.md`](FORM_GUIDE_IMAGE_TODO.md) (generated by the app repo's `scripts/list_drawn_form_guides.py --write`).
